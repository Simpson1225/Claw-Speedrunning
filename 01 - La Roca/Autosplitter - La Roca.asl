...
split {
	...
	*/
	...
	if (
		vars.split < 3
		&& current.xPos >= 3905 // Right of this
		&& current.xPos <= 4360 // Left of this
		&& current.yPos >= 4000 // Below this
		&& current.yPos <= 4480 // Above this
	) {
		vars.split = 3;
		return true;
	}
	...
	// After elevator cycle
	if (
		vars.split < 5
		&& current.xPos >= 9500 // Right of this
		&& current.xPos <= 9660 // Left of this
		&& current.yPos <= 2574 // Above this
	) {
		vars.split = 5;
		return true;
	}

	// After three block cycle
	if (
		vars.split < 6
		&& current.xPos >= 11720 // Right of this
	...
	if (
		vars.split < 8
		&& current.xPos >= 14580 // Right of this
		&& current.xPos <= 14800 // Left of this
		&& current.yPos <= 2000 // Above this
	) {
		vars.split = 8;
		return true;
