...
split {
	...
	*/
	...
	if (
		vars.split < 2
		&& current.xPos > 690 // Right of this
	) {
		vars.split = 2;
		return true;
	}
	...
	if (
		vars.split < 3
		&& current.xPos >= 2630 // Right of this
		&& current.xPos <= 2880 // Left of this
		&& current.yPos >= 3750 // Below this
	...
	if (
		vars.split < 4
		&& current.xPos >= 4200 // Right of this
		&& current.xPos <= 4420 // Left of this
		&& current.yPos >= 3000 // Below this
		&& current.yPos <= 3860 // Above this
	) {
		vars.split = 4;
		return true;
	}
	...
	if (
		vars.split < 5
		&& current.xPos >= 6860 // Right of this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 10700 // Right of this
		&& current.xPos <= 12000 // Left of this
	...
	if (
		vars.split < 7
		&& current.xPos >= 9400 // Right of this
		&& current.xPos <= 9700 // Left of this
		&& current.yPos >= 2250 // Below this
		&& current.yPos <= 2760 // Above this
	) {
		vars.split = 7;
		return true;
	}
	...
	if (
		vars.split < 8
		&& current.xPos >= 12640 // Right of this
		&& current.xPos <= 13100 // Left of this
		&& current.yPos >= 1500 // Below this
		&& current.yPos <= 1920 // Above this
	) {
		vars.split = 8;
		return true;
	}
	...
	if (
		vars.split < 9
		&& current.xPos >= 14220 // Right of this
	...
	if (
		vars.split < 10
		&& current.xPos >= 15730 // Right of this
		&& current.xPos <= 15860 // Left of this
		&& current.yPos <= 2390 // Above this
	) {
		vars.split = 10;
		return true;
	}
	...
	if (
		vars.split < 11
		&& current.xPos >= 17455 // Right of this
		&& current.yPos <= 1490 // Above this
	) {
		vars.split = 11;
		return true;
	}
