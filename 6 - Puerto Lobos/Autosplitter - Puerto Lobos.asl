...
split {
	...
	*/
	...
	if (
		vars.split < 4
		&& current.xPos >= 9050 // Right of this
	) {
		vars.split = 4;
		return true;
	}
	...
	if (
		vars.split < 5
		&& current.xPos >= 11930 // Right of this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 15600 // Right of this
	) {
		vars.split = 6;
		return true;
	}
	...
	if (
		vars.split < 7
		&& current.xPos >= 19320 // Right of this
	) {
		vars.split = 7;
		return true;
	}
	...
	if (
		vars.split < 9
		&& current.xPos >= 28930 // Right of this
	) {
		vars.split = 9;
		return true;
	}
