...
split {
	...
	*/
	...
	if (
		...
		&& current.xPos <= 5300 // Left of this
		&& current.yPos >= 4400 // Below this
	...
	if (
		vars.split < 4
		&& current.xPos >= 6300 // Right of this
		&& current.xPos <= 7270 // Left of this
		&& current.yPos >= 1000 // Below this
	...
	if (
		vars.split < 5
		&& current.xPos >= 7060 // Right of this
		&& current.xPos <= 7400 // Left of this
		&& current.yPos >= 4800 // Below this
		&& current.yPos <= 5400 // Above this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 8350 // Right of this
		&& current.xPos <= 8800 // Left of this
		&& current.yPos >= 3800 // Below this
		&& current.yPos <= 4230 // Above this
	) {
		vars.split = 6;
		return true;
	}
	...
	if (
		vars.split < 7
		&& current.xPos >= 9150 // Right of this
		&& current.xPos <= 9600 // Left of this
	...
	if (
		vars.split < 8
		&& current.xPos >= 10850 // Right of this
		&& current.xPos <= 11100 // Left of this
		&& current.yPos >= 1500 // Below this
		&& current.yPos <= 2000 // Above this
	) {
		vars.split = 8;
	...
	if (
		vars.split < 9
		&& current.xPos >= 9150 // Right of this
		&& current.xPos <= 10650 // Left of this
		&& current.yPos >= 4100 // Below this
		&& current.yPos <= 5900 // Above this
	) {
		vars.split = 9;
		return true;
	}
	...
	if (
		vars.split < 10
		&& current.xPos >= 11600 // Right of this
		&& current.xPos <= 11900 // Left of this
		&& current.yPos >= 3700 // Below this
		&& current.yPos <= 4200 // Above this
	) {
		vars.split = 10;
		return true;
	}
	...
	if (
		vars.split < 11
		&& current.xPos >= 22200 // Right of this
		&& current.xPos <= 24100 // Left of this
		&& current.yPos >= 4400 // Below this
		&& current.yPos <= 5240 // Above this
	) {
		vars.split = 11;
		return true;
	}
