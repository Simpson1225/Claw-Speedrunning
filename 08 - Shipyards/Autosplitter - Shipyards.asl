...
split {
	...
	*/
	...
	if (
		vars.split < 3
		&& current.xPos >= 3590 // Right of this
	) {
		vars.split = 3;
		return true;
	}
	...
	if (
		vars.split < 8
		&& current.xPos >= 17250 // Right of this
		&& current.xPos <= 17386 // Left of this
		&& current.yPos >= 4630 // Below this
		&& current.yPos <= 4805 // Above this
	) {
		vars.split = 8;
		return true;
	}
	...
	if (
		vars.split < 9
		&& current.xPos >= 40161 // Right of this
		&& current.xPos <= 40300 // Left of this
		&& current.yPos >= 5344 // Below this
		&& current.yPos <= 5528 // Above this
	) {
		vars.split = 9;
		return true;
	}
