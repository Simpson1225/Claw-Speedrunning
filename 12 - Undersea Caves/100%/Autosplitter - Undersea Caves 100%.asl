...
split {
	...
	*/
	...
	if (
		vars.split < 2
		&& current.xPos >= 1720  // Right of this
	) {
		vars.split = 2;
		return true;
	}
	...
	// Frost sword flag
		...
		vars.split < 3
		&& current.xPos >= 5150 // Right of this
		&& current.xPos <= 5530 // Left of this
		&& current.yPos >= 3450 // Below this
	...
	// Fountain
		...
		vars.split < 4
		&& current.xPos >= 8120 // Right of this
		&& current.xPos <= 8600 // Left of this
	...
	// Checkpoint 1
		...
		vars.split < 5
		&& current.xPos >= 11500 // Right of this
		&& current.xPos <= 11800 // Left of this
		&& current.yPos >= 3050 // Below this
	...
	// Crumble blocks
		...
		vars.split < 6
		&& current.xPos >= 17550 // Right of this
		&& current.xPos <= 18000 // Left of this
		&& current.yPos >= 2400 // Below this
	...
	// Spikes
		...
		vars.split < 7
		&& current.xPos >= 23200 // Right of this
		&& current.xPos <= 23600 // Left of this
	...
	// Big fall
		...
		vars.split < 8
		&& current.xPos >= 26220 // Right of this
		&& current.xPos <= 26800 // Left of this
	...
	// Checkpoint 2
		...
		vars.split < 9
		&& current.xPos >= 31520 // Right of this
		&& current.xPos <= 31800 // Left of this
		&& current.yPos >= 3250 // Below this
		&& current.yPos <= 4000 // Above this
	) {
		vars.split = 9;
	...
	// After stairway
		...
		vars.split < 10
		&& current.xPos >= 32400 // Right of this
		&& current.xPos <= 33300 // Left of this
		&& current.yPos >= 1900 // Below this
	...
	// Another stairway
		...
		vars.split < 11
		&& current.xPos >= 34150 // Right of this
		&& current.xPos <= 35000 // Left of this
		&& current.yPos >= 1900 // Below this
		&& current.yPos <= 2200 // Above this
	) {
		vars.split = 11;
	...
	// Finish
		...
		vars.split < 12
		&& current.xPos >= 36343 // Right of this
		&& current.yPos <= 2200 // Above this
	) {
		vars.split = 12;
		return true;
