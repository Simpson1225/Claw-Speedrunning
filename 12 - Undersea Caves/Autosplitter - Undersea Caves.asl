...
split {
	...
	*/
	...
	// After stairway 1
		...
		vars.split < 3
		&& current.xPos >= 4100 // Right of this
		&& current.yPos <= 2700 // Above this
	) {
		vars.split = 3;
		return true;
	}
	...
	// After stairway 2
		...
		vars.split < 4
		&& current.xPos >= 6320 // Right of this
	...
	// After stairway 3
		...
		vars.split < 5
		&& current.xPos >= 8680 // Right of this
	...
	// Flag ?
		...
		vars.split < 7
		&& current.xPos >= 17572 // Right of this
	) {
		vars.split = 7;
		return true;
	}
	...
	// Fish drawings
		...
		vars.split < 8
		&& current.xPos >= 20900 // Right of this
	) {
		vars.split = 8;
		return true;
	}
	...
	// Flag after big fall
		...
		vars.split < 9
		&& current.xPos >= 26300 // Right of this
	) {
		vars.split = 9;
		return true;
	}
	...
	// Flag after stairway
		...
		vars.split < 11
		&& current.xPos >= 32600 // Right of this
	) {
		vars.split = 11;
		return true;
	}

	// Flag after another stairway
	else if (
		vars.split < 12
		&& current.xPos >= 34400 // Right of this
	) {
		vars.split = 12;
		return true;
	}
