...
split {
	...
	*/
	...
	if (
		vars.split < 3
		&& current.xPos >= 5170 // Right of this
	) {
		vars.split = 3;
		return true;
	}
	...
	if (
		vars.split < 5
		&& current.xPos >= 13630 // Right of this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 16000 // Right of this
		&& current.xPos <= 16500 // Left of this
		&& current.yPos >= 7000 // Below this
	...
	if (
		vars.split < 7
		&& current.xPos >= 18900 // Right of this
		&& current.xPos <= 19350 // Left of this
		&& current.yPos >= 7000 // Below this
		&& current.yPos <= 7600 // Above this
	) {
		vars.split = 7;
	...
	if (
		vars.split < 8
		&& current.xPos >= 21730 // Right of this
		&& current.xPos <= 22300 // Left of this
	) {
		vars.split = 8;
		return true;
	}
	...
	if (
		vars.split < 9
		&& current.xPos >= 25000 // Right of this
		&& current.xPos <= 25600 // Left of this
		&& current.yPos <= 7360 // Above this
	) {
		vars.split = 9;
		return true;
	}
	...
	if (
		vars.split < 10
		&& current.xPos >= 27030 // Right of this
		&& current.xPos <= 27200 // Left of this
		&& current.yPos <= 6400 // Above this
	) {
		vars.split = 10;
		return true;
	}
	...
	if (
		vars.split < 11
		&& current.xPos >= 30200 // Right of this
		&& current.xPos <= 30400 // Left of this
	) {
		vars.split = 11;
		return true;
	}
