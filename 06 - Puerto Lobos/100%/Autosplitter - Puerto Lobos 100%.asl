...
split {
	...
	*/
	...
	if (
		vars.split < 4
		&& current.xPos >= 9000// Right of this
		&& current.xPos <= 9800 // Left of this
		&& current.yPos >= 3900 // Below this
		&& current.yPos <= 4900 // Above this
	) {
		vars.split = 4;
		return true;
	}
	...
	if (
		vars.split < 5
		&& current.xPos >= 10550 // Right of this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 14120 // Right of this
		&& current.xPos <= 14400 // Left of this
		&& current.yPos >= 4000 // Below this
		&& current.yPos <= 4330 // Above this
	) {
		vars.split = 6;
		return true;
	}
	...
	if (
		vars.split < 7
		&& current.xPos >= 16410 // Right of this
		&& current.xPos <= 16900 // Left of this
		&& current.yPos >= 4100 // Below this
		&& current.yPos <= 4430 // Above this
	) {
		vars.split = 7;
		return true;
	}
	...
	if (
		vars.split < 8
		&& current.xPos >= 3150 // Right of this
		&& current.xPos <= 3500 // Left of this
		&& current.yPos >= 6200 // Below this
		&& current.yPos <= 6600 // Above this
	) {
		vars.split = 8;
		return true;
	}
	...
	if (
		vars.split < 9
		&& current.xPos >= 19500 // Right of this
		&& current.xPos <= 20100 // Left of this
		&& current.yPos >= 5700 // Below this
		&& current.yPos <= 6300 // Above this
	) {
		vars.split = 9;
		return true;
	}
	...
	if (
		vars.split < 10
		&& current.xPos >= 25960 // Right of this
		&& current.xPos <= 27000 // Left of this
		&& current.yPos >= 4850 // Below this
	...
	if (
		vars.split < 11
		&& current.xPos >= 6500 // Right of this
		&& current.xPos <= 7000 // Left of this
		&& current.yPos >= 7100 // Below this
		&& current.yPos <= 7800 // Above this
	) {
		vars.split = 11;
		return true;
	}
	...
	if (
		vars.split < 12
		&& current.xPos >= 30620 // Right of this
