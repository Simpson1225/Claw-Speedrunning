...
split {
	...
	*/
	...
	if (
		vars.split < 2
		&& current.xPos >= 1740  // Right of this
	) {
		vars.split = 2;
		return true;
	}
	...
	if (
		vars.split < 3
		&& current.xPos >= 4760 // Right of this
	) {
		vars.split = 3;
		return true;
	}
	...
	if (
		vars.split < 4
		&& current.xPos >= 7300 // Right of this
		&& current.xPos <= 7800 // Left of this
		&& current.yPos <= 4300 // Above this
		&& current.yPos >= 3900 // Below this
	) {
		vars.split = 4;
		return true;
	}
	...
	if (
		vars.split < 5
		&& current.xPos >= 9900 // Right of this
		&& current.xPos <= 10150 // Left of this
		&& current.yPos <= 3300 // Above this
		&& current.yPos >= 2650 // Below this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 12050 // Right of this
		&& current.xPos <= 12600 // Left of this
		&& current.yPos <= 3300 // Above this
		&& current.yPos >= 2750 // Below this
	) {
		vars.split = 6;
		return true;
	}
	...
	if (
		vars.split < 7
		&& current.xPos >= 14650 // Right of this
		&& current.xPos <= 14900 // Left of this
	...
	if (
		vars.split < 8
		&& current.xPos >= 17420 // Right of this
		&& current.xPos <= 17750 // Left of this
	...
	if (
		vars.split < 9
		&& current.xPos >= 19875 // Right of this
		&& current.xPos <= 20400 // Left of this
		&& current.yPos <= 3700 // Above this
		&& current.yPos >= 3000 // Below this
	) {
		vars.split = 9;
		return true;
	}
	...
	if (
		vars.split < 10
		&& current.xPos >= 22800 // Right of this
		&& current.xPos <= 24000 // Left of this
	...
	if (
		vars.split < 11
		&& current.xPos >= 25200 // Right of this
		&& current.xPos <= 25500 // Left of this
		&& current.yPos <= 1700 // Above this
		&& current.yPos >= 630 // Below this
	) {
		vars.split = 11;
		return true;
	}

	// After final stairway
	if (
		vars.split < 12
		&& current.xPos >= 28430 // Right of this
	...
	if (
		vars.split < 13
		&& current.xPos >= 31130 // Right of this
		&& current.xPos <= 31235 // Left of this
