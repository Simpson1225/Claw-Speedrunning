...
split {
	...
	*/
	...
	if (
		vars.split < 4
		&& current.xPos >= 7230 // Right of this
	...
	if (
		vars.split < 5
		&& current.xPos >= 9250 // Right of this
	...
	if (
		vars.split < 7
		&& current.xPos >= 12900 // Right of this
		&& current.yPos <= 2350 // Above this
	) {
		vars.split = 7;
		return true;
	}
	...
	if (
		vars.split < 8
		&& current.xPos >= 15420 // Right of this
		&& current.yPos <= 2600 // Above this
	) {
		vars.split = 8;
		return true;
	...
	if (
		...
		&& current.yPos >= 2300 // Below this
	) {
		vars.split = 9;
		return true;
	}

	// Top of stairway by chameleon
	if (
		vars.split < 10
		&& current.xPos >= 20950 // Right of this
	...
	// Flag below invisibility
	if (
		vars.split < 11
		&& current.xPos >= 25300 // Right of this
	) {
		vars.split = 11;
		return true;
	}
