...
split {
	...
	*/
	...
	if (
		vars.split < 3
		&& current.xPos >= 6110 // Right of this
	) {
		vars.split = 3;
		return true;
	}
	...
	if (
		vars.split < 5
		&& current.xPos >= 9770 // Right of this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 13550 // Right of this
		&& current.yPos <= 8440 // Above this
	) {
		vars.split = 6;
		return true;
	}
	...
	// After skip or elevators
	if (
		vars.split < 8
		&& current.xPos >= 18250 // Right of this
		&& current.yPos < 5800 // Above this
	) {
		vars.split = 8;
		return true;
	}
	...
	if (
		vars.split < 9
		&& current.xPos >= 20000 // Right of this
	) {
		vars.split = 9;
		return true;
	}
