...
split {
	...
	*/
	...
	if (
		vars.split < 3
		&& current.xPos >= 2980 // Right of this
		&& current.xPos <= 3200 // Left of this
		&& current.yPos >= 7060 // Below this
	) {
		vars.split = 3;
		return true;
	}
	...
	if (
		vars.split < 4
		&& current.xPos <= 1863 // Left of this
		&& current.yPos <= 6619 // Above this
		&& current.yPos >= 6430 // Below this
	) {
		vars.split = 4;
		return true;
	}
	...
	if (
		vars.split < 5
		&& current.xPos >= 23000 // Right of this
		&& current.xPos <= 23140 // Left of this
		&& current.yPos <= 6180 // Above this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 22300 // Right of this
		&& current.xPos <= 23450 // Left of this
		&& current.yPos <= 5570 // Above this
	) {
		vars.split = 6;
		return true;
	}
