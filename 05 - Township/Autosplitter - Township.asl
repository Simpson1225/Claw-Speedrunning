...
split {
	...
	*/
	...
	if (
		vars.split < 5
		&& current.xPos >= 12450 // Right of this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 14500 // Right of this
	) {
		vars.split = 6;
		return true;
	}
	...
	if (
		vars.split < 7
		&& current.xPos >= 18450 // Right of this
	) {
		vars.split = 7;
		return true;
	}
	...
	if (
		vars.split < 8
		&& current.xPos >= 21000 // Right of this
	) {
		vars.split = 8;
		return true;
	}
	...
	if (
		vars.split < 9
		&& current.xPos >= 23130 // Right of this
	) {
		vars.split = 9;
		return true;
	}
	...
	if (
		vars.split < 11
		&& current.xPos >= 27500 // Right of this
	) {
		vars.split = 11;
		return true;
	}
