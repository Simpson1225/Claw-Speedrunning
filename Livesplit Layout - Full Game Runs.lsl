...
<Layout version="1.6.1">
  ...
  <VerticalHeight>634</VerticalHeight>
  <HorizontalWidth>-1</HorizontalWidth>
  <HorizontalHeight>-1</HorizontalHeight>
  <Settings>
    <TextColor>FFFFFFFF</TextColor>
    <BackgroundColor>FF000111</BackgroundColor>
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>C:\Dev\Projects\Claw Speedrunning\Claw-Speedrunning\0 - Full Game\Autosplitter - Claw.asl</ScriptPath>
        <Start>True</Start>
        <Reset>False</Reset>
        <Split>True</Split>
        <CustomSettings>
