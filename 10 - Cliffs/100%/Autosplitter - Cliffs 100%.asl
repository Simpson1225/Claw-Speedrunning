...
split {
	...
	*/
	...
	if (
		vars.split < 4
		&& current.xPos >= 6900 // Right of this
		&& current.xPos <= 7500 // Left of this
		&& current.yPos >= 9000 // Below this
		&& current.yPos <= 9500 // Above this
	) {
		vars.split = 4;
		return true;
	}
	...
	if (
		vars.split < 5
		&& current.xPos >= 10630 // Right of this
		&& current.xPos <= 11000 // Left of this
		&& current.yPos >= 9000 // Below this
		&& current.yPos <= 10000 // Above this
	) {
		vars.split = 5;
		return true;
	}
	...
	if (
		vars.split < 6
		&& current.xPos >= 17700 // Right of this
		&& current.xPos <= 18200 // Left of this
		&& current.yPos >= 8700 // Below this
		&& current.yPos <= 9100 // Above this
	) {
		vars.split = 6;
		return true;
	}
	...
	if (
		vars.split < 7
		&& current.xPos >= 19130 // Right of this
	...
	if (
		...
		&& current.xPos <= 23000 // Left of this
	) {
		vars.split = 8;
		return true;
	}
	...
	if (
		vars.split < 10
		&& current.xPos >= 27600 // Right of this
		&& current.xPos <= 28000 // Left of this
		&& current.yPos >= 7600 // Below this
